...
import shutil
import sys
# COCO related code has been removed
import cv2
import matplotlib
matplotlib.use('Agg')
...
def get_map(IOU_threshold = 0.5, draw_plot = False, path = './map_out'):
    MINOVERLAP = IOU_threshold
    ...
    with open(RESULTS_FILES_PATH + "/results.txt", 'w') as results_file:
        ...
        if n_classes == 0:
            print("No classes detected, please check label information and classes_path in get_map.py.")
            return 0
        results_file.write("\n# mAP of all classes\n")
